                    ...
                    <ul class="list-unstyled mb-0 d-flex gap-3 flex-wrap change-colors">
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-aqua.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-purple.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-green.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-cyan.min.css') }}')"
                        ...
                        <li
                            ...
                            <a href="javascript:void(0)"
                                ...
                                onclick="toggleTheme('{{ asset('dist/css/style-orange.min.css') }}')"
